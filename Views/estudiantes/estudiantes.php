            ...
            <form method="post" id="frm_estudiantes">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombre">Nombre del Estudiantes</label>
                        <input type="text" required class="form-control" id="Nombre" name="Nombre" placeholder="Ingrese el nombre del estudiante">
                    </div>
